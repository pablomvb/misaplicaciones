...
#include "../PARMP_mCliente/cliente.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Cliente_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 33, 19)
    ...
    "Cliente\0shell\0\0coneccionEntrante\0"
    "clienteDesconectado"
};
...
void Cliente::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->shell(); break;
        case 1: _t->coneccionEntrante(); break;
        case 2: _t->clienteDesconectado(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
